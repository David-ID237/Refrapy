...
class Refrainv(Tk):
    ...
    def __init__(self):
        ...
        self.ico_openPick = PhotoImage(file=Ruta_Base+"ico_loadPicks.gif")
        self.ico_invTimeterms = PhotoImage(file=Ruta_Base+"vm.gif")
        self.ico_invTomo = PhotoImage(file=Ruta_Base+"tomogram.gif")
        self.ico_layerMode = PhotoImage(file=Ruta_Base+"camadas.gif")
        self.ico_clearLayers = PhotoImage(file=Ruta_Base+"limpar.gif")
        self.ico_layer1 = PhotoImage(file=Ruta_Base+"layer1.gif")
        self.ico_layer2 = PhotoImage(file=Ruta_Base+"layer2.gif")
        self.ico_layer3 = PhotoImage(file=Ruta_Base+"layer3.gif")
        self.ico_reset = PhotoImage(file=Ruta_Base+"fechar.gif")
        self.ico_plotOptions = PhotoImage(file=Ruta_Base+"ico_plotOptions.gif")
        self.ico_save = PhotoImage(file=Ruta_Base+"salvar.gif")
        self.ico_fit = PhotoImage(file=Ruta_Base+"ico_fit.gif")
        self.ico_mergeResults = PhotoImage(file=Ruta_Base+"ico_mergeResults.gif")
        self.ico_velmesh = PhotoImage(file=Ruta_Base+"ico_velmesh.gif")
        self.ico_3d = PhotoImage(file=Ruta_Base+"ico_3d.gif")
...
""",font=("Arial", 11)).pack()
    ...
    def runTomography(self):
        ...
        if self.data_pg:
            ...
            tomoWindow.iconphoto(True, PhotoImage(file=Ruta_Base+"ico_refrapy.png"))
            ...
            def viewMesh():
                ...
                meshWindow.iconphoto(True, PhotoImage(file=Ruta_Base+"ico_refrapy.png"))
    ...
    def showFit(self):
        ...
        if self.data_pg:
            ...
            fitWindow.iconphoto(True, PhotoImage(file=Ruta_Base+"ico_refrapy.png"))
    ...
    def showPgResult(self):
        ...
        if self.tomoPlot:
            ...
            pgWindow.iconphoto(True, PhotoImage(file=Ruta_Base+"ico_refrapy.png"))
    ...
    def build3d(self):
        ...
        if self.tomoPlot or self.timetermsPlot:
            ...
            if self.coords_3d:
                ...
                plot3dwindow.iconphoto(True, PhotoImage(file=Ruta_Base+"ico_refrapy.png"))
