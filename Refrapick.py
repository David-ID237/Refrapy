...
Ruta_Base="/home/david/Refrapy/images/"
...
class Refrapick(Tk):
    ...
    def __init__(self):
        ...
        self.iconphoto(True, PhotoImage(file=Ruta_Base+"ico_refrapy.png"))
        photo = PhotoImage(file=Ruta_Base+"ico_refrapy.gif")
        ...
        initialise(self)
        self.ico_openWaveform = PhotoImage(file=Ruta_Base+"abrir.gif")
        self.ico_savePicks = PhotoImage(file=Ruta_Base+"salvar.gif")
        self.ico_nextWf = PhotoImage(file=Ruta_Base+"proximo.gif")
        self.ico_previousWf = PhotoImage(file=Ruta_Base+"voltar.gif")
        self.ico_expandY = PhotoImage(file=Ruta_Base+"baixo.gif")
        self.ico_zoomY = PhotoImage(file=Ruta_Base+"cima.gif")
        self.ico_moreGain = PhotoImage(file=Ruta_Base+"mais.gif")
        self.ico_lessGain = PhotoImage(file=Ruta_Base+"menos.gif")
        self.ico_invertY = PhotoImage(file=Ruta_Base+"invert.gif")
        self.ico_trim = PhotoImage(file=Ruta_Base+"cortar.gif")
        self.ico_wiggles = PhotoImage(file=Ruta_Base+"fill_null.gif")
        self.ico_fillNeg = PhotoImage(file=Ruta_Base+"fill_neg.gif")
        self.ico_fillPos = PhotoImage(file=Ruta_Base+"fill_pos.gif")
        self.ico_clip = PhotoImage(file=Ruta_Base+"clip.gif")
        self.ico_filters = PhotoImage(file=Ruta_Base+"ico_filter.gif")
        self.ico_pick = PhotoImage(file=Ruta_Base+"pick.gif")
        self.ico_connectPick = PhotoImage(file=Ruta_Base+"ligar.gif")
        self.ico_clearPicks = PhotoImage(file=Ruta_Base+"limpar.gif")
        self.ico_velMode = PhotoImage(file=Ruta_Base+"vel.gif")
        self.ico_tt = PhotoImage(file=Ruta_Base+"grafico.gif")
        self.ico_options = PhotoImage(file=Ruta_Base+"opt.gif")
        self.ico_reset = PhotoImage(file=Ruta_Base+"fechar.gif")
        self.ico_newProject = PhotoImage(file=Ruta_Base+"ico_newProject.gif")
        self.ico_loadProject = PhotoImage(file=Ruta_Base+"ico_loadProject.gif")
        self.ico_resample = PhotoImage(file=Ruta_Base+"ico_resample.gif")
        self.ico_survey = PhotoImage(file=Ruta_Base+"ico_survey.gif")
        self.ico_shotTime = PhotoImage(file=Ruta_Base+"ico_shotTime.gif")
        self.ico_loadPicks = PhotoImage(file=Ruta_Base+"ico_loadPicks.gif")
        self.ico_allPicks = PhotoImage(file=Ruta_Base+"ico_allPicks.gif")
        self.ico_restoreTraces = PhotoImage(file=Ruta_Base+"ico_restoreTraces.gif")
        self.ico_help = PhotoImage(file=Ruta_Base+"ico_help.gif")
        self.ico_plotOptions = PhotoImage(file=Ruta_Base+"ico_plotOptions.gif")
    ...
    def plotOptions(self):
        ...
        plotOptionsWindow.iconphoto(True, PhotoImage(file=Ruta_Base+"ico_refrapy.png"))
    ...
    def options(self):
        ...
        if self.sts:
            ...
            optionsWindow.iconphoto(True, PhotoImage(file=Ruta_Base+"ico_refrapy.png"))
    ...
    def help(self):
        ...
        helpWindow.iconphoto(True, PhotoImage(file=Ruta_Base+"ico_refrapy.png"))
...
""",font=("Arial", 11)).pack()
    ...
    def viewSurvey(self):
        ...
        if self.sts:
            ...
            surveyWindow.iconphoto(True, PhotoImage(file=Ruta_Base+"ico_refrapy.png"))
    ...
    def viewTraveltimes(self):
        ...
        if self.sts:
            ...
            if pickExists:
                ...
                ttWindow.iconphoto(True, PhotoImage(file=Ruta_Base+"ico_refrapy.png"))
